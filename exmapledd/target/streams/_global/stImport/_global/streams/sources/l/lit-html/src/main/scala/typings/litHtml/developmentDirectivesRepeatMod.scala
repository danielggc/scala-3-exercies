...
object developmentDirectivesRepeatMod {
  
  @JSImport("lit-html/development/directives/repeat", "RepeatDirective")
  @js.native
  ...
  @JSImport("lit-html/development/directives/repeat", "repeat")
  @js.native
