...
object developmentDirectivesClassMapMod {
  
  @JSImport("lit-html/development/directives/class-map", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("lit-html/development/directives/class-map", "ClassMapDirective")
  @js.native
