...
import typings.litHtml.developmentLitHtmlMod.ElementPart
import typings.std.Parameters
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object developmentDirectivesRefMod {
  
  @JSImport("lit-html/development/directives/ref", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("lit-html/development/directives/ref", "RefDirective")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("lit-html/development/directives/ref", "Ref")
  @js.native
