...
trait TypeofMonthPicker extends StObject {
...
object TypeofMonthPicker {
  
  inline def apply(i18nBundle: default, onDefine: () => js.Promise[Unit]): TypeofMonthPicker = {
    val __obj = js.Dynamic.literal(i18nBundle = i18nBundle.asInstanceOf[js.Any], onDefine = js.Any.fromFunction0(onDefine))
    __obj.asInstanceOf[TypeofMonthPicker]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofMonthPicker] (val x: Self) extends AnyVal {
