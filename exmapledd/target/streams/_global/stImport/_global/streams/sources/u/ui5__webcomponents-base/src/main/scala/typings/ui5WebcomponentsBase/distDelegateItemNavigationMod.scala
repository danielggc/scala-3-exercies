...
import typings.ui5WebcomponentsBase.distTypesItemNavigationBehaviorMod.ItemNavigationBehavior
import typings.ui5WebcomponentsBase.distTypesNavigationModeMod.NavigationMode
...
object distDelegateItemNavigationMod {
  ...
  open class default protected ()
    ...
    /**
      ...
      */
    def this(
      rootWebComponent: typings.ui5WebcomponentsBase.distUi5elementMod.default,
    ...
    /* CompleteClass */
    var rootWebComponent: typings.ui5WebcomponentsBase.distUi5elementMod.default = js.native
  ...
  object ITabbable {
    ...
    inline def apply(_tabIndex: String, id: String): ITabbable = {
      val __obj = js.Dynamic.literal(_tabIndex = _tabIndex.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
  ...
  trait ItemNavigation extends StObject {
    ...
    var rootWebComponent: typings.ui5WebcomponentsBase.distUi5elementMod.default
  ...
  object ItemNavigation {
    ...
    implicit open class MutableBuilder[Self <: ItemNavigation] (val x: Self) extends AnyVal {
      ...
      inline def setRootWebComponent(value: typings.ui5WebcomponentsBase.distUi5elementMod.default): Self = StObject.set(x, "rootWebComponent", value.asInstanceOf[js.Any])
