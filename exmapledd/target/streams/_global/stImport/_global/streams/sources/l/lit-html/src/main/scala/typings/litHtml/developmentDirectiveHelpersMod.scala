...
object developmentDirectiveHelpersMod {
  
  @JSImport("lit-html/development/directive-helpers", JSImport.Namespace)
  @js.native
  ...
  */
  ...
  object TemplateResultType {
    ...
    @JSImport("lit-html/development/directive-helpers", "TemplateResultType.HTML")
    @js.native
    val HTML: `1` = js.native
    
    @JSImport("lit-html/development/directive-helpers", "TemplateResultType.SVG")
    @js.native
    val SVG: `2` = js.native
  }
  ...
  @JSImport("lit-html/development/directive-helpers", "isTemplateResult")
  @js.native
  ...
  trait IsTemplateResult_ extends StObject {
    ...
    def apply[T /* <: TemplateResultType */](`val`: Any, `type`: T): /* is lit-html.lit-html/development/lit-html.TemplateResult<T> */ Boolean = js.native
  }
