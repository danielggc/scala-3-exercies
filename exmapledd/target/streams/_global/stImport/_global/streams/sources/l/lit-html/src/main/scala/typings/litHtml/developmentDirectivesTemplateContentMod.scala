...
object developmentDirectivesTemplateContentMod {
  
  @JSImport("lit-html/development/directives/template-content", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("lit-html/development/directives/template-content", "TemplateContentDirective")
  @js.native
