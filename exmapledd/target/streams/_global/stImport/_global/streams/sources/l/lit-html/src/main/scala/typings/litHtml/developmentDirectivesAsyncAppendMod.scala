...
import typings.litHtml.developmentDirectivesAsyncReplaceMod.AsyncReplaceDirective
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object developmentDirectivesAsyncAppendMod {
  
  @JSImport("lit-html/development/directives/async-append", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("lit-html/development/directives/async-append", "AsyncAppendDirective")
  @js.native
