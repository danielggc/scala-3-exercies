...
object distAssetRegistriesIllustrationsMod {
  ...
  object IllustrationData {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(dialogSvg = dialogSvg.asInstanceOf[js.Any], sceneSvg = sceneSvg.asInstanceOf[js.Any], set = set.asInstanceOf[js.Any], spotSvg = spotSvg.asInstanceOf[js.Any], subtitle = subtitle.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any])
  ...
  object IllustrationProperties {
    ...
    inline def apply(dialogSvg: String, sceneSvg: String, spotSvg: String, subtitle: I18nText, title: I18nText): IllustrationProperties = {
      val __obj = js.Dynamic.literal(dialogSvg = dialogSvg.asInstanceOf[js.Any], sceneSvg = sceneSvg.asInstanceOf[js.Any], spotSvg = spotSvg.asInstanceOf[js.Any], subtitle = subtitle.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any])
