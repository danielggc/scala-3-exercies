...
open class ZipWriter[Type] protected () extends StObject {
  def this(writer: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AsyncGenerator<Writer<unknown> | WritableWriter | WritableStream, boolean> */ Any) = this()
  ...
  def this(
    writer: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AsyncGenerator<Writer<unknown> | WritableWriter | WritableStream, boolean> */ Any,
