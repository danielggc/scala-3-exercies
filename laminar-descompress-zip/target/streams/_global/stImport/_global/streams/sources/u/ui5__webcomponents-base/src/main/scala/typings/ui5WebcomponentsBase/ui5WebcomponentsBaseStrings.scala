...
object ui5WebcomponentsBaseStrings {
  
  @js.native
  sealed trait ICON_NOT_FOUND extends StObject
  ...
  @js.native
  sealed trait horizon extends StObject
  inline def horizon: horizon = "horizon".asInstanceOf[horizon]
