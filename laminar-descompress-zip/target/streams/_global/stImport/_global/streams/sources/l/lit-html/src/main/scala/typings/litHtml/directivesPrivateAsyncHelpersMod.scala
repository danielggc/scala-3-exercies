...
object directivesPrivateAsyncHelpersMod {
  
  @JSImport("lit-html/directives/private-async-helpers", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("lit-html/directives/private-async-helpers", "Pauser")
  @js.native
  ...
  @JSImport("lit-html/directives/private-async-helpers", "PseudoWeakRef")
  @js.native
