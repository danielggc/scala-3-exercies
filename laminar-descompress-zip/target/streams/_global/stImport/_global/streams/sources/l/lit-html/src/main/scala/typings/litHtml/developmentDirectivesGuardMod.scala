...
object developmentDirectivesGuardMod {
  
  @JSImport("lit-html/development/directives/guard", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("lit-html/development/directives/guard", "GuardDirective")
  @js.native
