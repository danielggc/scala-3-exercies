...
import typings.ui5WebcomponentsLocalization.distDatesUniversalDateMod.UniversalDate
...
object distDatesCalendarDateMod {
  ...
  object default {
    ...
    /* static member */
    inline def fromLocalJSDate(oJSDate: js.Date): CalendarDate = ^.asInstanceOf[js.Dynamic].applyDynamic("fromLocalJSDate")(oJSDate.asInstanceOf[js.Any]).asInstanceOf[CalendarDate]
    inline def fromLocalJSDate(oJSDate: js.Date, sCalendarType: CalendarType): CalendarDate = (^.asInstanceOf[js.Dynamic].applyDynamic("fromLocalJSDate")(oJSDate.asInstanceOf[js.Any], sCalendarType.asInstanceOf[js.Any])).asInstanceOf[CalendarDate]
    
    /* static member */
    inline def fromTimestamp(iTimestamp: Double): CalendarDate = ^.asInstanceOf[js.Dynamic].applyDynamic("fromTimestamp")(iTimestamp.asInstanceOf[js.Any]).asInstanceOf[CalendarDate]
    inline def fromTimestamp(iTimestamp: Double, sCalendarType: CalendarType): CalendarDate = (^.asInstanceOf[js.Dynamic].applyDynamic("fromTimestamp")(iTimestamp.asInstanceOf[js.Any], sCalendarType.asInstanceOf[js.Any])).asInstanceOf[CalendarDate]
  }
  
  @js.native
  trait CalendarDate extends StObject {
    
    var _oUDate: js.Date | UniversalDate = js.native
    ...
    def toLocalJSDate(): js.Date = js.native
    
    def toUTCJSDate(): js.Date = js.native
  }
}
