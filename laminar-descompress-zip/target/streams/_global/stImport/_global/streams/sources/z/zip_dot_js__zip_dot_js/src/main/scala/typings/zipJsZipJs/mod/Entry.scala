...
trait Entry extends StObject {
  ...
  var getData: js.UndefOr[
    js.Function2[
      /* writer */ Writer[Any] | WritableWriter | WritableStream[Any], 
...
object Entry {
  ...
  implicit open class MutableBuilder[Self <: Entry] (val x: Self) extends AnyVal {
    ...
    inline def setGetData(
      value: (/* writer */ Writer[Any] | WritableWriter | WritableStream[Any], /* options */ js.UndefOr[EntryGetDataOptions]) => js.Promise[Any]
