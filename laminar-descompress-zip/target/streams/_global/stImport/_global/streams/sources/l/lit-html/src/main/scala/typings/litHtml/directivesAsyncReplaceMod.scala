...
object directivesAsyncReplaceMod {
  
  @JSImport("lit-html/directives/async-replace", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("lit-html/directives/async-replace", "AsyncReplaceDirective")
  @js.native
