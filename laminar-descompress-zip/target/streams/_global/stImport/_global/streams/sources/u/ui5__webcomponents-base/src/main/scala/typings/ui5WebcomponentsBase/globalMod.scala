...
object globalMod {
  ...
  object global {
    ...
    /* augmented module */
    object cssJsAugmentingMod extends Shortcut {
      
      @JSImport("*.css.js", JSImport.Default)
      @js.native
      val default: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify StyleData */ Any = js.native
      
      type _To = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify StyleData */ Any
      
      /* This means you don't have to write `default`, but can instead just say `cssJsAugmentingMod.foo` */
      override def _to: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify StyleData */ Any = default
    }
