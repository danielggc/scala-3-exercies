...
object developmentDirectivesUnsafeSvgMod {
  
  @JSImport("lit-html/development/directives/unsafe-svg", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("lit-html/development/directives/unsafe-svg", "UnsafeSVGDirective")
  @js.native
  ...
  object UnsafeSVGDirective {
    ...
    /* static member */
    @JSImport("lit-html/development/directives/unsafe-svg", "UnsafeSVGDirective.directiveName")
    @js.native
    ...
    /* static member */
    @JSImport("lit-html/development/directives/unsafe-svg", "UnsafeSVGDirective.resultType")
    @js.native
