...
trait TypeofCalendarHeader extends StObject {
...
object TypeofCalendarHeader {
  
  inline def apply(i18nBundle: default, onDefine: () => js.Promise[Unit]): TypeofCalendarHeader = {
    val __obj = js.Dynamic.literal(i18nBundle = i18nBundle.asInstanceOf[js.Any], onDefine = js.Any.fromFunction0(onDefine))
    __obj.asInstanceOf[TypeofCalendarHeader]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofCalendarHeader] (val x: Self) extends AnyVal {
