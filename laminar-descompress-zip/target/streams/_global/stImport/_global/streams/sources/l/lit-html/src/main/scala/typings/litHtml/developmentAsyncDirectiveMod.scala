...
object developmentAsyncDirectiveMod {
  
  @JSImport("lit-html/development/async-directive", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* note: abstract class */ @JSImport("lit-html/development/async-directive", "AsyncDirective")
  @js.native
  ...
  @JSImport("lit-html/development/async-directive", "AttributePart")
  @js.native
  ...
  @JSImport("lit-html/development/async-directive", "BooleanAttributePart")
  @js.native
  ...
  @JSImport("lit-html/development/async-directive", "ChildPart")
  @js.native
  ...
  /* note: abstract class */ @JSImport("lit-html/development/async-directive", "Directive")
  @js.native
  ...
  @JSImport("lit-html/development/async-directive", "ElementPart")
  @js.native
  ...
  @JSImport("lit-html/development/async-directive", "EventPart")
  @js.native
  ...
  object PartType {
    ...
    @JSImport("lit-html/development/async-directive", "PartType.ATTRIBUTE")
    @js.native
    val ATTRIBUTE: `1` = js.native
    
    @JSImport("lit-html/development/async-directive", "PartType.BOOLEAN_ATTRIBUTE")
    @js.native
    val BOOLEAN_ATTRIBUTE: `4` = js.native
    
    @JSImport("lit-html/development/async-directive", "PartType.CHILD")
    @js.native
    val CHILD: `2` = js.native
    
    @JSImport("lit-html/development/async-directive", "PartType.ELEMENT")
    @js.native
    val ELEMENT: `6` = js.native
    
    @JSImport("lit-html/development/async-directive", "PartType.EVENT")
    @js.native
    val EVENT: `5` = js.native
    
    @JSImport("lit-html/development/async-directive", "PartType.PROPERTY")
    @js.native
    val PROPERTY: `3` = js.native
  }
  
  @JSImport("lit-html/development/async-directive", "PropertyPart")
  @js.native
