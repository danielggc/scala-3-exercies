...
object developmentDirectiveMod {
  
  @JSImport("lit-html/development/directive", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("lit-html/development/directive", "AttributePart")
  @js.native
  ...
  @JSImport("lit-html/development/directive", "BooleanAttributePart")
  @js.native
  ...
  @JSImport("lit-html/development/directive", "ChildPart")
  @js.native
  ...
  /* note: abstract class */ @JSImport("lit-html/development/directive", "Directive")
  @js.native
  ...
  @JSImport("lit-html/development/directive", "ElementPart")
  @js.native
  ...
  @JSImport("lit-html/development/directive", "EventPart")
  @js.native
  ...
  */
  ...
  object PartType {
    ...
    @JSImport("lit-html/development/directive", "PartType.ATTRIBUTE")
    @js.native
    val ATTRIBUTE: `1` = js.native
    
    @JSImport("lit-html/development/directive", "PartType.BOOLEAN_ATTRIBUTE")
    @js.native
    val BOOLEAN_ATTRIBUTE: `4` = js.native
    
    @JSImport("lit-html/development/directive", "PartType.CHILD")
    @js.native
    val CHILD: `2` = js.native
    
    @JSImport("lit-html/development/directive", "PartType.ELEMENT")
    @js.native
    val ELEMENT: `6` = js.native
    
    @JSImport("lit-html/development/directive", "PartType.EVENT")
    @js.native
    val EVENT: `5` = js.native
    
    @JSImport("lit-html/development/directive", "PartType.PROPERTY")
    @js.native
    val PROPERTY: `3` = js.native
  }
  
  @JSImport("lit-html/development/directive", "PropertyPart")
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.litHtml.developmentDirectiveMod.ChildPartInfo
    - typings.litHtml.developmentDirectiveMod.AttributePartInfo
    - typings.litHtml.developmentDirectiveMod.ElementPartInfo
  */
  trait PartInfo extends StObject
  object PartInfo {
    
    inline def AttributePartInfo(name: String, tagName: String, `type`: `1` | `3` | `4` | `5`): typings.litHtml.developmentDirectiveMod.AttributePartInfo = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], tagName = tagName.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.litHtml.developmentDirectiveMod.AttributePartInfo]
    }
    
    inline def ChildPartInfo(): typings.litHtml.developmentDirectiveMod.ChildPartInfo = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(2)
      __obj.asInstanceOf[typings.litHtml.developmentDirectiveMod.ChildPartInfo]
    }
    
    inline def ElementPartInfo(): typings.litHtml.developmentDirectiveMod.ElementPartInfo = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(6)
      __obj.asInstanceOf[typings.litHtml.developmentDirectiveMod.ElementPartInfo]
    }
  }
}
